...
Admin pass codes are shown once when created. Send each person only their own pass. Revoke a pass from the same admin page when someone should no longer have access.
