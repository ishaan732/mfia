...
const samplePosts = [
  {
    ...
    shutter: "Not listed",
    category: "Street",
    story: "Real monsoon street photo from Mumbai. Photographer: Rakesh Krishna Kumar. Source: Wikimedia Commons, CC BY-SA 2.0.",
    author: "Rakesh Krishna Kumar",
    image: "./assets/real-street-rain.jpg",
    likes: 32,
  ...
  },
  {
    ...
    shutter: "Not listed",
    category: "Landscape",
    story: "Real Pangong Lake landscape photograph. Photographer: Harsh243919. Source: Wikimedia Commons, CC BY-SA 4.0.",
    author: "Harsh243919",
    image: "./assets/real-pangong-lake.jpg",
    likes: 57,
  ...
  },
  {
    ...
    camera: "Not listed",
    lens: "Available light",
    iso: "Not listed",
    aperture: "Not listed",
    shutter: "Not listed",
    category: "Portrait",
    story: "Real available-light portrait. Photographer: Danieljksn. Source: Wikimedia Commons, CC BY-SA 4.0.",
    author: "Danieljksn",
    image: "./assets/real-window-portrait.jpg",
    likes: 44,
  ...
  },
  {
    ...
    shutter: "Not listed",
    category: "Wildlife",
    story: "Real grey heron in-flight photograph. Photographer: Kailash Kumbhkar. Source: Wikimedia Commons, CC BY-SA 4.0.",
    author: "Kailash Kumbhkar",
    image: "./assets/real-heron-flight.jpg",
    likes: 71,
...
function migratePost(post, userId) {
  const isSample = post.sample || Boolean(sampleImageByTitle[post.title]) || sampleSignatures.has(`${post.title}|${post.author}`);
  if (isSample) {
    return {
      ...post,
      sample: true,
